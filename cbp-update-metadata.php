 ...
 * Description: Upload CSV or XLSX files to update SEO meta titles and descriptions by URL, with dry-run support. Auto-detects Yoast or SEOPress.
 * Version: 1.1.0
 ...
 * Auto-detects the active SEO plugin (Yoast or SEOPress) and writes to the appropriate post meta keys.
 *
...
class CBP_Update_Metadata_Plugin {
	...
	/**
	 * Returns the post meta keys for the active SEO plugin.
	 *
	...
	/**
	 * Returns the human-readable label of the detected SEO plugin.
	 *
	 * @return string The detected SEO plugin label.
	 */
	private function get_detected_engine(): string {
		return $this->is_seopress_active() ? 'SEOPress' : 'Yoast SEO';
	}
